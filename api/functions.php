    ...
    class functions extends REST {
        ...
        public function appBanner(){
            ...
            $flag = array(); 
                ...
                $query = "SELECT * FROM tbl_app_banners";
        ...
        public function forgotPassword() {
            ...
            $uniqidStr = md5(uniqid(mt_rand()));
                ...
                if ($row['email'] != "") {
					...
					$mail->Subject = "[IMPORTANT] GNASHER YT Forgot Password Information";
												  ...
												  <tr>
													...
													<!--  <a href ="http://multigames.skywinner.in/ghfytjvj456/reset-password.php?fp_code='.$uniqidStr.'">Reset Password</a>-->
													  <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;margin-bottom:30px;">Thanks you,<br />
														<a href="https://www.youtube.com/channel/UCz4nXDl9sjaczWIrs3e5Q-A?view_as=subscriber">GNASHER YT</a>.</p></td>
												  </tr>
												</tbody>
											  </table></td>
										  </tr>
